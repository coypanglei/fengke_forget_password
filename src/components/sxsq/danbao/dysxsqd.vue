          ...
          >
            ...
            >
              <p
                ...
                v-show=" grantId == ''"
              >
                <a-button type="primary" @click="shanchua()" v-show="imageadressa!==''">
              ...
              <div style="padding:15px 35px" v-show="imageadressa==''" id="shouquanshua">
                ...
                <div style="display:flex;margin:10px;margin-top:30px;">
                  <div  style="display: flex;align-items: flex-start;flex-flow: column;justify-content: center;margin-right:30px;">
  ...
  methods: {
    ...
    baocunxinxi() {
      ...
      if (obj.id == null || obj.id == '') {
        ...
        let shuju = document.getElementById('shouquanshua')
        html2canvas(shuju, {
          useCORS: true
        }).then(canvas => {
          ...
          formData.append('file', this.dataURLtoFile(dataURL, filename + '.png'))
          postAction('/sys/common/upload', formData).then(res => {
            if (res.success == true) {
     ...
     shengimga(){
      let shujua = document.getElementById("shujuasa")
