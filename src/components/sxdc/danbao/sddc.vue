        ...
        <div class="jibenb">
          <div class="jibenb_a" v-for="(item,index) in jingYingDiaoCha" :key="index">
            ...
            <textarea
              v-show="item.status == '5' "
              :value="item.value"
              style="width:891px;height:98px;padding:8px;font-size:12px;color: black;border-radius: 4px;border: 1px solid #d9d9d9;"
              :placeholder="item.placehold"
        ...
        <div class="jibenb">
          ...
          >
            ...
            <textarea
              v-show="item.status == '5' "
              :value="item.value"
              style="width:891px;height:150px;padding:8px;font-size:12px;color: black;border-radius: 4px;border: 1px solid #d9d9d9;"
              :placeholder="item.placehold"
     ...
     if (this.leibie == '工薪类') {
      ...
      this.diaocha = [
        ...
        },
        {
          ...
          value: '',
          status: '2',
          second: [{ name: '自由可转让' }, { name: '自由不可转让' }, { name: '其他' }]
        },
        {
          paraName: 'jysx',
          name: '经营事项',
