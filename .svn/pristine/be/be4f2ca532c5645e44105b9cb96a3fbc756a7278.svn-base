      ...
      <div :style="persryle">
        ...
        <div class="zhuti">
          ...
          <div class="zhuti_right">
            <bjzl v-show="name=='背景资料'" ref="beijing" :id="id"></bjzl>
            <jyqk v-show="name=='经营情况'" ref="jingyinga" :id="id"></jyqk>
            <bzr v-show="name=='保证人情况'" ref="baozhengren" :id="id"></bzr>
            <sxbj v-show="name=='授信背景资料'" ref="shouxinbeijing" :id="id"></sxbj>
