    ...
    <div class="popupApply-box">
      <div class="popupApply-content flex">
        ...
        <div
          ...
          style="padding:20px 40px;width:80%;    display: flex;
    justify-content: center;
    "
          v-show="biglist[17].status"
        >
          <a-spin :spinning="yingzhe">
            <div class="yingyin" style="display:flex;flex-wrap: wrap;margin-top: 165px;">
        ...
        >
          <!-- 年收入情况 -->
          <nsrqk ref="nsrqka" :seediaocha="seediaocha"
            :leibie="leibie"
            :instid="instid"
            :id="id"
            :sxid="sxid"
        ...
        <div class="link-content flex-1" style="width:80%" v-show="biglist[14].status">
          ...
          <QyDbaofx v-show="danbaoList[3].status" :seediaocha="seediaocha" ref="diyb" :sxid="sxid"></QyDbaofx>
          <SxsqDyfxList
...
export default {
  ...
  data() {
    return {
      ...
      crosshairs: '',
      style: '',
      shangxia: [{ name: '上游供应商', status: true }, { name: '下游客户', status: false }],
      // 抵押担保头部
      danbaoList: [
      ...
      smalllist: [
        ...
        // 授信调查审批
        { name: '授信调查审批表', title: '授信调查审批表(授信调查审批表)', status: false, wan: false, fileList: [] }
      ],
  ...
  methods: {
    ...
    // //console.log(date, dateString)
    // //console.log( this.shouxin[5].value )
    // this.shouxin[5].value = dateString
    ...
    //授信调查调查日
    // diaochaDay(date, dateString) {
    //   //console.log(date, dateString)
    //   this.shouxin[6].value = dateString
