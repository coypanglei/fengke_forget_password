    ...
    >
      <template>
        <div :style="persryle">
          ...
          <personal @changediaochatitle="changediaochatitle" :seediaocha='seediaocha'  :leibie="leibie" :id="id" :instid="instid" :taskid="taskid" :sxid="sxid" style="height:100%" v-on:closeNowPop="closeNowPop"></personal>
        </div>
      </template>
    </a-modal>
