      ...
      <div class="jiben">
        ...
        <div class="jibenb">
          <div class="shouxin">
            ...
            <p class="shouxinb">
              <span class="right">基层分类意见:</span>
              <a-textarea
                class="textarea"
                autosize
                :value="jiCengFenLei"
                @change="(e)=>{jiCengFenLei =e.target.value }"
              />
            </p>
            <p class="shouxinb">
              <span class="right">负责人:</span>
              <a-input type="text" :value="fezeren" @change="(e)=>{fezeren =e.target.value }" />
            </p>
            <p class="shouxinb">
              <span class="right">县级总行分类意见:</span>
              <a-textarea
                class="textarea"
                autosize
                :value="xianJi"
                @change="(e)=>{xianJi =e.target.value }"
              />
            </p>
            <p class="shouxinb">
              <span class="right">分类结果:</span>
              <a-input
                type="text"
                :value="fenLeiJieGuo"
                @change="(e)=>{fenLeiJieGuo =e.target.value }"
              />
            </p>
          </div>
        </div>
