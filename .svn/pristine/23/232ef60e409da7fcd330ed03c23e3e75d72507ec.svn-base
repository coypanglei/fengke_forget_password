<template>
  <div>
    ...
    <div class="jia_top" style="border:none;">
      <a-button type="primary" :loading="loading" v-show="cha" v-if="baocunBtn" icon = 'save' @click="baocunxinxi()" >保存</a-button>
      <a-button style="margin-left:15px;" v-show="cha" v-print="'#printContent'" ghost type="primary" icon="printer">打印</a-button>
    </div>
        ...
        <div class="shou_all" style="width: 100%;border: 1px solid #000000;margin-top:5px;">
          ...
          <div style="border-bottom:1px solid #000000 ;">
            ...
            <p style="margin-top:20px;display:flex;align-items: center;">
              ...
              <span @click="sxsqjda('授权人b')" v-else style="color:#5eaaee;font-size:20px;margin-left:10px;">点击进入手写板</span>
            </p>
