      ...
      <div :style="persryle">
        ...
        <div class="zhuti">
          ...
          <div class="zhuti_right">
            ...
            <!-- 非财务分析 -->
            <fcwfx v-show="name=='非财务分析'" ref="feicaiwu" :id="id" :feilei='feilei' :sshy='sshy'></fcwfx>
            <!-- 汇法网查询 -->
            <huifawang v-show="name=='汇法网查询'" ref='hfw' :id="id"></huifawang>
            <!-- 征信查询  -->
            <zhengxin v-show="name=='征信查询'" ref='zx' :id="id" :zjhm='zjhm'></zhengxin>
            <!-- 检查结论 -->
...
import huifawang from './dgdkhfw' //汇法网
import zhengxin from './dgdkzxcx' //征信查询
  ...
  methods: {
    ...
    _biglist(e) {
      ...
      if (this.biglist[e].name == '影像资料') {
        ...
        this.$refs.zx.getshuju()
      } else if (this.biglist[e].name == '汇法网查询') {
        this.$refs.hfw.getshuju()
